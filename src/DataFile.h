...
public:
    ...
    bool RetrieveQuotedStringParameter(const char * const param, char **val,
                                       int *size, bool searchFromStart = true);
    ...
    bool ReadNextLine2(char *line, int size, bool ignoreEmpty,
    ...
    ptrdiff_t GetSize() { return m_Size; }
    void ClearData();
    ...
    static int CountTokens(const char *string);
    static int ReturnTokens(char *string, char *ptrs[], int size);
    static int CountTokens(const char *string, const char *separators);
    static int ReturnTokens(char *string, char *ptrs[], int size, const char *separators);
    static void Strip(char *str);
    static bool StringEndsWith(const char * str, const char * suffix);
    static double Double(const char *buf);
    static void Double(const char *buf, int n, double *d);
    static int Int(const char *buf);
    static void Int(const char *buf, int n, int *d);
